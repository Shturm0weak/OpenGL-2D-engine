...
Triangle2D::Triangle2D(float speed, glm::mat4 pos, float angle, Renderer& renderer) {
...
void Triangle2D::OnRunning(glm::mat4 proj, Renderer& renderer, double deltatime) {
	if (collide) {
		angle = PI - angle;
		speed = defspeed;
